...
**No. 7 insert** 是面向《战舰世界》WG 服的开源战绩查询与对局助手。首次公开版本为 **V0.1.1**。

## 下载完整程序

Windows 安装版和便携版放在 [V0.1.1 发布页](https://github.com/awhite1127/wws-no-7-insert/releases/tag/V0.1.1)。安装版支持选择安装目录并创建快捷方式；便携版可直接运行。两者包含相同功能与图标。
